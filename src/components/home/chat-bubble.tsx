...
const ChatBubble = ({ me, message, previousMessage }: ChatBubbleProps) => {
  ...
  const bgClass = fromMe ? "bg-indigo-chat" : "bg-white dark:bg-gray-primary";
...
const SelfMessageIndicator = () => (
  <div className="absolute bg-indigo-chat top-0 -right-[3px] w-3 h-3 rounded-br-full overflow-hidden" />
);
